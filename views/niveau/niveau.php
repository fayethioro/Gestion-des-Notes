            ...
            <div class="cycle classe dflex">
                ...
                <label>
                    <select>
                            ...
                            <?php foreach ($params['posts'] as $cycle): ?>
                                <option value=""><?=$cycle->nom_cycle?></option>
                            <?php endforeach;?>
                                ...
                                <div class="modal-body">
                                    <form action="\niveau" method="post">
                                        <div dflex fdc jcc>
                                            <label>Cycle
                                                <select>
                                                    <?php foreach ($params['cycles'] as $niveau): ?>
                                                        <option value=""><?=$niveau->nom_cycle?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </label>
                                            <label for="id_niveau">Niveau:</label>
                                            <input type="text" name="id-niveau" id="id-niveau">
                                        </div>
